...
const cities = {
  ...
  petrolina: {
    ...
    whatsapp: '5587981410015',
    phone: '+5587981410015',
    phoneDisplay: '(87) 9.8141-0015',
    email: 'd2blocos.pisos@gmail.com',
      ...
      >
        <div className="max-w-7xl mx-auto px-5 md:px-10 flex items-center justify-between">
          ...
          <div className={`hidden md:flex items-center gap-1 px-2 py-1.5 rounded-full transition-all duration-300 ${
            ...
            {['Produtos', 'Vantagens', 'Depoimentos', 'Unidades', 'Contato'].map((item) => (
              <a
                key={item}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {['Produtos', 'Vantagens', 'Depoimentos', 'Unidades', 'Contato'].map((link) => (
                  <li key={link}>
